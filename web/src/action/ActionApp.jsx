...
function TheoVe({ email }) {
  ...
  if (ketQua?.ok) return (
    <Khung>
      ...
      <NutMoDashboard />
      <p className="mt-3 text-[11px] text-muted">Có thể đóng tab này.</p>
    </Khung>)
  ...
  return (
    <Khung>
      <DauTrang phu={email} />
      <p className="text-[11px] uppercase tracking-wider text-muted font-semibold mt-4">Xác nhận thao tác · {tenVaiTro(v.vai_tro_can)}</p>
