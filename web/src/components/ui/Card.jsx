...
export function SectionTitle({ icon: Icon, children, hint }) { return <h2 className="text-sm font-semibold flex items-center gap-2" style={{ color: "var(--text-strong)" }}><Icon className="w-4 h-4" style={{ color: "var(--primary)" }} strokeWidth={1.8} />{children}{hint && <span className="text-[12px] font-normal text-muted">— {hint}</span>}</h2>; }
