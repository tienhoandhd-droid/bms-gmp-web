...
export default function MobileBottomNav({ tab, setTab, role, badges = {}, onMoThem }) {
  ...
  return (
    <nav className="bms-bottom-nav lg:hidden fixed bottom-0 inset-x-0 z-40 bg-surface border-t border-line pb-[env(safe-area-inset-bottom)]" aria-label="Điều hướng nhanh">
