...
> **CẬP NHẬT 04/09/2026: WF5 v3 (`CKekaM0QRPl40GhQ`) đã thay v2 làm bản chính thức** — lịch v2 đã tắt,
> v2 chỉ còn phục vụ webhook "Gửi báo cáo bù" cho tới khi web đổi sang webhook v3. Xem `report-templates/BO-RAP-V3.md`.
