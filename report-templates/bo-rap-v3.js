...
function khoiLichSuBanIn(d) {
  ...
  return '<h3>So với bốn kỳ trước</h3>'
    ...
    + '<div class="cuon-ngang"><table><thead><tr><th>Kỳ</th><th class="so">Toàn nhà máy</th>'
...
function rapBaoCao(d, duBao, cfg) {
  ...
  const khoiLichSuIn = khoiLichSuBanIn(d);
